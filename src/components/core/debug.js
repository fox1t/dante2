...
class Debug extends React.Component {
  ...
  testEmitAndDecode (e) {
    const rawAsJson = this.props.editor.emitSerializedOutput()
    this.props.editor.setState({
      editorState: this.props.editor.decodeEditorContent(rawAsJson) },
    this.logState(JSON.stringify(rawAsJson)))
    return false
  }
